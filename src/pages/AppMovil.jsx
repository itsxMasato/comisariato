        ...
        <section className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <span className="text-primary font-bold tracking-widest label-md uppercase">
                Comisariato Pro
              </span>
              ...
              <p className="text-on-surface-variant text-lg max-w-xl">
                Gestiona tus beneficios de forma eficiente. Realiza pedidos
                rápidos, consulta tu saldo en Lempiras en tiempo real y reserva
                productos exclusivos desde cualquier lugar.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8 bg-surface-container-low p-8 rounded-[2rem] border border-outline-variant/10 shadow-sm">
              <div className="flex-grow w-full sm:w-auto">
                <a
                  href="/comisariato.apk"
                  download="ComisariatoPro.apk"
                  ...
                  <div className="p-4 flex flex-col gap-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-[10px] font-bold text-on-surface-variant leading-none">
                            Bienvenido
                          </p>
                  ...
                  <div className="p-4 flex flex-col gap-3">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div
                          key={item.name}
                          className="flex gap-3 items-center p-2 bg-surface-container-low rounded-xl"
                        >
                          <div className="w-11 h-11 bg-white rounded-lg flex-shrink-0 flex items-center justify-center">
                            <span className="material-symbols-outlined text-surface-container-highest text-xl">
                              grocery
                            </span>
                          </div>
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-on-surface-variant max-w-2xl mx-auto">
                Sigue estos sencillos pasos para tener{" "}
                <strong>Comisariato Pro</strong> configurado en tu dispositivo
                Android en menos de 2 minutos.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Haz clic en 'Descargar APK' para obtener el instalador oficial de Comisariato Pro.",
                },
                {
                  n: 2,
                  icon: "security",
                  title: "Habilita orígenes",
                  desc: "En ajustes de seguridad, permite la instalación de aplicaciones de orígenes desconocidos.",
                },
                {
                  n: 3,
                  icon: "login",
                  title: "Inicia sesión",
                  desc: "Abre Comisariato Pro e ingresa con tu código de empleado y contraseña del portal corporativo.",
                },
              ].map(({ n, icon, title, desc }) => (
                <div
                  key={n}
                  className="group relative bg-surface-container-lowest p-8 rounded-[2rem] border border-transparent hover:border-primary/20 transition-all duration-300"
                >
                  <div className="absolute -top-4 -left-4 w-12 h-12 primary-gradient text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg">
                    {n}
                  </div>
          ...
          <div className="glass-card p-12 rounded-[2.5rem] border border-outline-variant/30 flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden relative">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <p className="text-on-surface-variant text-lg max-w-lg">
                Si experimentas dificultades con la descarga o instalación de{" "}
                <strong>Comisariato Pro</strong>, nuestro equipo está listo para
